...
样本：23287 篇（正样本 9321 / 负样本 13966），负样本为按年份分层匹配的正常研究论文。

## 模型对比（5 折分层交叉验证，均值 ± 标准差）

| 模型 | AUC | PR-AUC | F1 | Brier |
| --- | --- | --- | --- | --- |
| 逻辑回归 | 0.795 ± 0.005 | 0.718 ± 0.009 | 0.678 ± 0.007 | 0.185 ± 0.002 |
| LightGBM | 0.856 ± 0.006 | 0.812 ± 0.009 | 0.706 ± 0.009 | 0.150 ± 0.003 |
| 随机森林 | 0.828 ± 0.005 | 0.776 ± 0.006 | 0.684 ± 0.006 | 0.186 ± 0.001 |
...
| --- | --- | --- | --- | --- | --- |
| 逻辑回归 | ≤2024 | 17177 | 6110 | 0.712 | 0.338 |
| LightGBM | ≤2024 | 17177 | 6110 | 0.713 | 0.319 |

## 诚实声明（局限）

- 样本 23287 篇，结论是「相关性」而非「因果」，不能用于判断某篇具体文献是否会被撤稿。
